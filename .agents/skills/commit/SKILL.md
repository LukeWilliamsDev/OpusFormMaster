...
1. `git pull https://github.com/LukeWilliamsDev/OpusFormMaster.git [Target Branch]` to align with remote.
2. Verify no new env files, secrets, or credentials are staged.
3. `git add .`
4. `git commit -m "[Message]"`
5. `git push https://github.com/LukeWilliamsDev/OpusFormMaster.git [Target Branch]`
