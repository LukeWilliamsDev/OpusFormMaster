...
export const NavList = ({ activeUrl, items, className, iconOnly = false, isActive }: NavListProps) => {
                                ...
                                <ul className="pb-1">
                                    {item.items.map((childItem) => (
                                        <li key={childItem.label} className="py-0.25">
                                            <NavItemBase href={childItem.href} type="collapsible-child" current={activeUrl === childItem.href}>
                                                {childItem.label}
                                            </NavItemBase>
                                        </li>
                                    ))}
