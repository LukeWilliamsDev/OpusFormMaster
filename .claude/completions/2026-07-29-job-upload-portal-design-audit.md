...
### 3. **Upload Form — Standard Drag & Drop**
...
<form onSubmit={handleSubmit} className="space-y-6">
  ...
  <button
    ...
    className={cn(
      "w-full py-3 rounded-xl text-xs font-bold uppercase tracking-wider transition-all flex justify-center items-center gap-2",
