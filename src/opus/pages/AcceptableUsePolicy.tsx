...
export const AcceptableUsePolicyPage: React.FC = () => (
  <LegalPageLayout title="Acceptable Use Policy" lastUpdated="July 2026">
    <Section title="1. Purpose">
      <p>
        This Acceptable Use Policy ("<strong style={{ color: '#d4d4d8' }}>AUP</strong>") sets out the rules governing your 
        use of the Opus Form Ltd internal workforce management portal. It supplements our{' '}
        <a href="#/portal/terms" className="underline" style={{ color: '#6C8295' }}>Portal Usage Policy</a> and applies to all 
        employees, contractors, and operatives with portal access.
      </p>
    </Section>
    ...
    <Section title="2. Prohibited Activities">
      ...
      <ul className="list-disc list-inside space-y-1.5 ml-1">
        <li>Attempt to gain unauthorised access to any part of the Service, other users' accounts, or connected systems</li>
        <li>Use the Service to store, distribute, or transmit malicious software (malware, viruses, trojans)</li>
        <li>Scrape, harvest, or extract data from the Service by automated means without prior written consent</li>
        ...
        <li>Attempt to circumvent security controls, Row-Level Security policies, or role-based access restrictions</li>
        <li>Use the Service for any purpose that is unlawful under the laws of England and Wales</li>
    ...
    <Section title="3. Account Responsibilities">
      ...
      <ul className="list-disc list-inside space-y-1.5 ml-1">
        ...
        <li>Reporting any suspected security incident or unauthorised access to{' '}
          <a href="mailto:admin@opusform.co.uk" className="underline" style={{ color: '#6C8295' }}>admin@opusform.co.uk</a>{' '}
          immediately
        </li>
        <li>Ensuring compliance documents you upload are genuine, current, and accurately represent your qualifications</li>
      </ul>
    </Section>
    ...
    <Section title="4. Data Handling">
      ...
      <ul className="list-disc list-inside space-y-1.5 ml-1">
        <li>Only access data that your role permits — do not attempt to access other users' records</li>
        <li>Not export, copy, or share personal data from the Service except as authorised by an administrator</li>
        <li>Handle any personal data you access in accordance with the UK General Data Protection Regulation (UK GDPR)</li>
