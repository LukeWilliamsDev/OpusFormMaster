    ...
    <div className="space-y-5">
      ...
      <div className="bg-card border border-border rounded-xl overflow-hidden shadow-2xl">
        ...
        <div className="hidden md:grid md:grid-cols-[120px_2.2fr_1.3fr_1.5fr_110px_100px] gap-4 px-5 py-3.5 border-b border-border bg-muted/40">
          <span className="text-[11px] font-bold tracking-wider uppercase text-muted-foreground">Job Ref</span>
          <span className="text-[11px] font-bold tracking-wider uppercase text-muted-foreground">Site / Contractor</span>
          <span className="text-[11px] font-bold tracking-wider uppercase text-muted-foreground">Site Warnings</span>
          <span className="text-[11px] font-bold tracking-wider uppercase text-muted-foreground">Pour Progress</span>
          <span className="text-[11px] font-bold tracking-wider uppercase text-muted-foreground text-right">Value</span>
          <span className="text-[11px] font-bold tracking-wider uppercase text-muted-foreground text-right">Status</span>
        </div>
                  ...
                  >
                    ...
                    <div className="w-full md:w-auto space-y-0.5 py-1">
                      ...
                      <div className="md:hidden space-y-2 mt-3 pt-2.5 border-t border-border">
                        ...
                        <div className="flex items-center justify-between text-[12px] text-foreground">
                          <span className="font-semibold">Value: <span className="font-mono text-foreground">£{Number(job.scheduleValue || 0).toLocaleString('en-GB')}</span></span>
                          <span className="font-semibold">Pours: <span className="font-mono text-foreground">{job.currentPours} / {job.contractMaxPours}</span></span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="hidden md:flex flex-col w-full space-y-1 py-1 text-left">
                      <div className="flex justify-between text-[11px] font-bold text-muted-foreground">
                        ...
                        <span className="font-mono text-foreground">{progressPercent.toFixed(0)}%</span>
                      </div>
