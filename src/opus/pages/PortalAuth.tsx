    ...
    <div className="min-h-screen bg-[#111114] text-[#E4E4E7] flex flex-col items-center justify-center p-4 sm:p-6 relative overflow-hidden font-sans">
      ...
      {notification && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
          <div 
            className={`bg-[#242424] border ${notification.type === 'success' ? 'border-[#5C7285]/40' : 'border-red-500/20'} rounded-lg max-w-sm w-full p-5 shadow-lg relative`}
          ...
          >
            ...
            <button 
              onClick={handleDismissNotification}
              className="w-full mt-5 py-2 px-4 bg-[#2e2e2e] hover:bg-[#383838] text-[9px] font-extrabold uppercase tracking-widest text-[#e0e0e0] rounded-md transition-colors border border-[#3e3e3e] cursor-pointer"
            >
              Dismiss
            </button>
          </div>
