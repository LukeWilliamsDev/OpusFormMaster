...
export const TermsOfServicePage: React.FC = () => (
  <LegalPageLayout title="Portal Usage Policy" lastUpdated="July 2026">
    <Section title="1. About This Policy">
      <p>
        This Portal Usage Policy governs the use of the Opus Form workforce management portal
        by employees, contractors, and operatives of <strong style={{ color: '#d4d4d8' }}>Opus Form Ltd</strong> (Company
        No. 17228356). It is an internal company policy, not a commercial service agreement.
      </p>
      <p>
        By accessing the portal, you confirm that you have read and understood this policy and
        agree to abide by its terms as a condition of your engagement with the company.
      </p>
    </Section>

    <Section title="2. Portal Purpose">
      <p>
        The Opus Form portal is an internal business tool providing:
      </p>
    ...
    <Section title="3. Access & Credentials">
      <p>
        Portal access is provided by a company administrator. You are responsible for:
      </p>
      <ul className="list-disc list-inside space-y-1.5 ml-1">
        ...
        <li>Reporting any suspected unauthorised access immediately to{' '}
          <a href="mailto:admin@opusform.co.uk" className="underline" style={{ color: '#6C8295' }}>admin@opusform.co.uk</a>
        </li>
      </ul>
    </Section>
    ...
    <Section title="4. Acceptable Use">
      <p>
        ...
        <a href="#/portal/acceptable-use" className="underline" style={{ color: '#6C8295' }}>Acceptable Use Policy</a>.
        Misuse of the portal may result in disciplinary action up to and including termination
        of your engagement with the company.
      </p>
    </Section>
    ...
    <Section title="5. Data & Accuracy">
      ...
      <p>
        Entering false or misleading information, particularly regarding compliance certificates,
        is a serious breach and may have legal consequences under health and safety legislation.
      </p>
    </Section>
    ...
    <Section title="6. Data Protection">
      <p>
        ...
        <a href="#/privacy" className="underline" style={{ color: '#6C8295' }}>Staff Privacy Notice</a>,
    ...
    <Section title="7. Intellectual Property">
      <p>
        The portal software, design, and documentation are the property of Opus Form Ltd.
        You must not copy, modify, distribute, or reverse-engineer any part of the portal
        without written authorisation from a company director.
      </p>
    </Section>

    <Section title="8. Availability">
      <p>
        While we aim to keep the portal available at all times, we may need to take it offline
        for maintenance, updates, or security patches. We will provide reasonable notice where
    ...
    <Section title="9. Termination of Access">
      <p>
        Your access to the portal will be revoked when your engagement with Opus Form Ltd ends,
        or if you breach this policy. Upon termination of access, your data will be retained in
    ...
    <Section title="10. Governing Law">
      <p>
        ...
        <strong style={{ color: '#d4d4d8' }}>England and Wales</strong>.
      </p>
    </Section>
