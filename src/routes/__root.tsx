...
const THEME_INIT_SCRIPT = `(function(){try{var t=localStorage.getItem("opus_portal_theme");if(t==="light"){document.documentElement.classList.add("light-theme");}}catch(e){}})();`;
