...
description: Offensive security specialist conducting authorized penetration tests, red team operations, and vulnerability assessments across networks, web applications, and cloud infrastructure. Use PROACTIVELY when the user requests security/penetration testing of the app.
color: "#dc2626"
emoji: 🗡️
