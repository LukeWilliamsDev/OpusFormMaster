...
const SITE_ACCORDION_BG = "bg-stone-100 dark:bg-slate-800/50 border-2 border-stone-200 dark:border-slate-700 rounded-xl";
const SITE_ACCORDION_HEADER = "w-full flex items-center justify-between gap-2 px-3 py-2.5 text-left cursor-pointer hover:bg-stone-200/50 dark:hover:bg-slate-700/50 transition-colors";
    ...
    <div className={SITE_ACCORDION_BG}>
      ...
      >
        <span className="flex items-center gap-2 min-w-0">
          ...
          <span className="text-[10px] font-black text-stone-500 dark:text-stone-400 shrink-0">({count})</span>
        </span>
        <ChevronDown
